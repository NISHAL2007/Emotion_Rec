...
class EmotionCoachGUI:
    ...
    def _build_ui(self):
        ...
        self.lbl_trend = tk.Label(coach_frame, text="Initializing session trend tracking...", bg="#2A2A2A", fg="#FFB800", font=("Segoe UI", 9), wraplength=340, justify=tk.LEFT, padx=8, pady=8)
